    ...
    <svg viewBox="0 0 400 300" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      <defs>
        <linearGradient id="fb-sky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#A33E1F" />
          <stop offset="100%" stopColor="#A33E1F" />
        </linearGradient>
      ...
      <g transform="translate(290 90)">
        ...
        <circle r="46" fill="none" stroke="#E2CFA9" strokeWidth="1.5" />
        <path d="M0 -20 L19 -6 L12 17 L-12 17 L-19 -6 Z" fill="#3B2A1E" />
        <g fill="#3B2A1E" opacity="0.85">
    ...
    <svg viewBox="0 0 400 300" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      <defs>
        <linearGradient id="bd-bg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#C5532F" />
          <stop offset="100%" stopColor="#A33E1F" />
        </linearGradient>
      </defs>
      ...
      <g transform="translate(250 120) rotate(25)">
        ...
        <g stroke="#FBF4E6" strokeWidth="1.4">
          <path d="M0 26 L-18 -48" /><path d="M0 26 L-7 -55" />
          <path d="M0 26 L7 -55" /><path d="M0 26 L18 -48" />
        </g>
        <circle cx="0" cy="30" r="13" fill="#C5860F" />
        <circle cx="0" cy="30" r="13" fill="none" stroke="#C5860F" strokeWidth="1.5" />
      </g>
    </svg>
  );
}
...
export function WeddingArt({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 400 300" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      ...
      {/* arch */}
      <path d="M70 300 Q70 70 200 70 Q330 70 330 300" fill="none" stroke="#F1C9B4" strokeOpacity="0.35" strokeWidth="3" />
      {/* florals on arch */}
      <g fill="#F1C9B4" opacity="0.5">
      ...
      <g transform="translate(200 180)" fill="none" strokeWidth="9">
        <circle cx="-22" cy="0" r="34" stroke="#C5860F" />
        <circle cx="22" cy="0" r="34" stroke="#F1C9B4" />
      </g>
    ...
    <svg viewBox="0 0 480 360" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      <defs>
        <radialGradient id="hr-glow" cx="72%" cy="38%" r="62%">
          <stop offset="0%" stopColor="#F6DD9E" stopOpacity="0.75" />
          <stop offset="100%" stopColor="#F6DD9E" stopOpacity="0" />
        </radialGradient>
      </defs>
      ...
      <g transform="translate(360 150)">
        <circle r="40" fill="#FBF4E6" />
        <path d="M0 -17 L16 -5 L10 14 L-10 14 L-16 -5 Z" fill="#3B2A1E" />
        <g fill="#3B2A1E" opacity="0.85">
      ...
      <g transform="translate(180 250) rotate(20)" opacity="0.9">
        <path d="M0 18 L-22 -34 Q0 -42 22 -34 Z" fill="#F1C9B4" />
        <circle cx="0" cy="20" r="9" fill="#C5860F" />
      </g>
      {/* rings */}
      <g transform="translate(420 285)" fill="none" strokeWidth="5" opacity="0.85">
        <circle cx="-13" cy="0" r="18" stroke="#C5860F" />
        <circle cx="13" cy="0" r="18" stroke="#F1C9B4" />
      </g>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 400 300" className={className} preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      <defs>
        <linearGradient id="cf-bg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#C5860F" />
          <stop offset="100%" stopColor="#C5860F" />
        </linearGradient>
      </defs>
      <rect width="400" height="300" fill="url(#cf-bg)" />
      {/* steam */}
      <g stroke="#FFFBF2" strokeOpacity="0.5" strokeWidth="5" fill="none" strokeLinecap="round">
        <path d="M188 96 q-14 -20 0 -40 q14 -20 0 -40" />
        <path d="M214 96 q-14 -20 0 -40 q14 -20 0 -40" />
      </g>
      {/* cup */}
      <g transform="translate(200 188)">
        <path d="M-66 -30 h120 v18 q0 70 -60 70 q-60 0 -60 -70 Z" fill="#3B2A1E" />
        <path d="M-66 -30 h120 v10 h-120 Z" fill="#7A5638" />
        <ellipse cx="-6" cy="-30" rx="60" ry="14" fill="#7A5638" />
        <ellipse cx="-6" cy="-32" rx="48" ry="9" fill="#3B2A1E" />
        <path d="M54 -18 q40 0 40 30 q0 30 -40 26 v-14 q22 4 22 -12 q0 -16 -22 -16 Z" fill="#3B2A1E" />
