      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="relative h-80 md:h-[420px] overflow-hidden border-[3px] border-[#3B2A1E]" style={{ boxShadow: '5px 5px 0 #C5860F' }}>
              <Image
      ...
      <section id="gallery" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-3 grid-rows-2 gap-3 h-[480px]">
            {GALLERY.map((img) => (
              <div key={img.src} className={`relative overflow-hidden border-2 border-[#3B2A1E] ${img.span}`}>
                <Image
                  src={img.src}
